 ...
 /* [优化] 添加区域适配移动端 */
  ...
  async function handleRequest(request, env, ctx) {
    ...
    <head>
      ...
      <title>专利代理师导航站 - 精品网址导航</title>
      <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+SC:wght@300;400;500;700&display=swap" rel="stylesheet"/>
      <link rel="icon" href="https://zhjwork.onlineimages/head/a.webp" type="image/webp"/>
      ...
      <main class="main-content lg:ml-64 min-h-screen transition-all duration-300">
        ...
        <footer class="bg-white py-8 px-6 mt-12 border-t border-gray-200">
          <div class="max-w-5xl mx-auto text-center">
            <p class="text-gray-500">© ${new Date().getFullYear()} 知产工具箱 | 愿你在此找到方向</p>
